      ...
      list: [
        {
          ...
          answer: [
            `학생회와 동아리는 별도로 운영되기에 지원은 가능하지만, 기능부 활동이 어려울 정도로 동아리에 많이 가입되어 있다면 지원이 어려워요.\n
        ...
        },
        {
          ...
          answer: [
            ...
            이외에도 한세톤 웹 페이지, 어울림한마당 웹 페이지 등 교내 행사에 필요한 다양한 소프트웨어의 개발을 진행하고 있어요.`,
          ],
        },
        {
          ...
          answer: [
            <>
              Frontend: TypeScript에 대한 기본적인 이해와,
        ...
        },
        {
          ...
          answer: [
            `교내 학생들을 위한 퀄리티 있는 소프트웨어를 제작해야 할 책임이 있는 기능부는 특성상, 그 무엇보다 개발 능력이 중요해요.\n
            이러한 개발 능력을 평가하기 위해, 학생회 임원 1차 면접 이후 내드린 과제를 해결하고 해당 과제에 대한 질문과 응답을 하는 2차 과제전형과 2차 면접이 있어요.`,
          ],
        },
        {
        ...
        },
        {
          ...
          answer: [
            `지원자님 본인이 전부 이해하고 직접 작성한 코드인지를 가장 중요하게 보고 있어요. 이를 위해 2차 기술 인터뷰를 진행하는 거에요.\n
            본인이 전부 이해 및 작성한 코드가 맞다고 판단되면, 전반적인 코드의 완성도와 요구사항 구현도 등을 평가해요.`,
          ],
        },
        {
